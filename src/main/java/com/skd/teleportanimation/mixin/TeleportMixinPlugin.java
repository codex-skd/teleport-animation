...
public final class TeleportMixinPlugin implements IMixinConfigPlugin {
    private static final String JOURNEYMAP_MIXIN = "com.skd.teleportanimation.mixin.JourneyMapClientNetworkDispatcherMixin";
    private static final String VOXY_CLIENT_MIXIN = "com.skd.teleportanimation.mixin.VoxyClientMixin";
    private static final String DISTANT_HORIZONS_RENDER_UTIL_MIXIN = "com.skd.teleportanimation.mixin.DistantHorizonsRenderUtilMixin";
    private static final String WAYSTONES_WARP_PLATE_MIXIN = "com.skd.teleportanimation.mixin.WaystonesWarpPlateBlockEntityMixin";
    private static final String WAYSTONES_TELEPORT_MIXIN = "com.skd.teleportanimation.mixin.WaystonesPlayerWaystoneManagerMixin";
