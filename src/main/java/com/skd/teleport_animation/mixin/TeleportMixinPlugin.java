...
public final class TeleportMixinPlugin implements IMixinConfigPlugin {
    ...
    private static final String LEAWIND_THIRD_PERSON_NEOFORGE_EVENTS_MIXIN = "com.skd.teleport_animation.mixin.LeawindThirdPersonEventsNeoForgeMixin";
    ...
    private static final String WAYSTONES_INTERNAL_METHODS_MIXIN = "com.skd.teleport_animation.mixin.WaystonesInternalMethodsMixin";
