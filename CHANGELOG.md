...
- **Spanish (`es_es`) locale**: full translation of all 30 keys (config screen, zoom-height stage
  labels, layout-editor controls). Taken from the Mystical Realms Translation & Fixes resource-pack
  QA pass so it ships with the mod. No code change.
