...
import dev.codex.gtaliketeleport.BobbyCompat;
import dev.codex.gtaliketeleport.DimensionIds;
import dev.codex.gtaliketeleport.DistantHorizonsCompat;
import dev.codex.gtaliketeleport.GtaLikeTeleportClient;
import dev.codex.gtaliketeleport.GtaLikeTeleportConfig;
import dev.codex.gtaliketeleport.IrisCompat;
import dev.codex.gtaliketeleport.SodiumCompat;
import dev.codex.gtaliketeleport.TeleportDestinationParser;
import dev.codex.gtaliketeleport.TeleportSounds;
import dev.codex.gtaliketeleport.VoxyCompat;
...
public final class TeleportTransitionController {
    ...
    private static void start(Minecraft client, Vec3 plannedTarget, String targetDimensionId, Runnable action, boolean closeOpenScreen, boolean stablePlannedTarget, int source) {
        ...
        startCameraEyeOffset = startEye.m_82546_(playerEye);
        ...
        startDimension = client.f_91073_ == null ? Level.f_46428_ : client.f_91073_.m_46472_();
        plannedTargetDimensionId = TeleportTransitionController.normalizeTargetDimensionId(targetDimensionId);
        previousCameraType = client.f_91066_.m_92176_();
        previousHudHidden = client.f_91066_.f_92062_;
        previousSmartCull = client.f_90980_;
        startPlayerYaw = player.m_146908_();
        ...
        startSurfaceY = TeleportTransitionController.getSkyFacingSurfaceY(client, startFeet, TeleportTransitionController.startFeet.f_82480_);
        arrivalSurfaceY = skipTravel ? Double.NaN : TeleportTransitionController.resolveSkyFacingSurfaceY(client, plannedTargetFeet, plannedTargetFeet == null ? TeleportTransitionController.startFeet.f_82480_ : TeleportTransitionController.plannedTargetFeet.f_82480_);
        ...
        if (client.f_91080_ != null) {
            if (closeOpenScreen) {
                ...
                client.f_91080_ = null;
            }
        }
        client.f_91066_.m_92157_(CameraType.THIRD_PERSON_BACK);
    ...
    static void tick(Minecraft client) {
        ...
        if (client.f_91074_ == null || client.f_91073_ == null || client.m_91403_() == null) {
            TeleportTransitionController.clear(client);
            return;
        }
        if (client.f_91074_.m_21224_()) {
            TeleportTransitionController.clear(client);
            return;
        }
        ...
        Vec3 playerFeet = TeleportTransitionController.getFeetPos(client.f_91074_);
        ...
        if (!cameraReleasePrepared && ticks > totalTicks) {
            ...
            TeleportTransitionController.syncPlayerInterpolationState(client.f_91074_);
        ...
        if (cameraReleasePrepared && !cameraReleased && ticks > totalTicks + TeleportTransitionController.getCameraReleaseHoldTicks()) {
            ...
            cameraReleased = true;
            TeleportTransitionController.restoreSmartCull(client);
    ...
    static float getProgress() {
        ...
        return Mth.m_14036_((float)((float)ticks / (float)totalTicks), (float)0.0f, (float)1.0f);
    }
    ...
    public static boolean shouldBlockGameplayInput() {
        ...
        return client == null || client.f_91080_ == null;
    }
    ...
    public static Vec3 stabilizeCameraInsideBlock(Vec3 pos) {
        ...
        Minecraft client = Minecraft.m_91087_();
        if (client == null || client.f_91073_ == null || !TeleportTransitionController.isCameraViewBlocked(client, pos)) {
            return pos;
        }
    ...
    private static boolean isCameraViewBlocked(Minecraft client, Vec3 pos) {
        if (client == null || client.f_91073_ == null || pos == null) {
            return false;
        }
        BlockPos blockPos = BlockPos.m_274446_((Position)pos);
        BlockState state = client.f_91073_.m_8055_(blockPos);
        return state.m_60831_((BlockGetter)client.f_91073_, blockPos);
    }
    ...
    private static double tryGetSkyFacingSurfaceY(Minecraft client, Vec3 feet) {
        int z;
        if (client == null || client.f_91073_ == null || feet == null) {
            return Double.NaN;
        }
        int x = Mth.m_14107_((double)feet.f_82479_);
        if (!client.f_91073_.m_7232_(x >> 4, (z = Mth.m_14107_((double)feet.f_82481_)) >> 4)) {
            return Double.NaN;
        }
        int surfaceY = client.f_91073_.m_6924_(Heightmap.Types.WORLD_SURFACE, x, z);
        if (surfaceY <= client.f_91073_.m_141937_()) {
            return Double.NaN;
        }
        return surfaceY;
    }
    ...
    private static double getUnresolvedSkyFacingSurfaceFallbackY(Minecraft client, double fallbackY) {
        ...
        if (TeleportTransitionController.isOpenSkyDimension(client)) {
            safeFallback = Math.max(safeFallback, (double)client.f_91073_.m_5736_() + 16.0);
    ...
    private static boolean isOpenSkyDimension(Minecraft client) {
        return client != null && client.f_91073_ != null && client.f_91073_.m_6042_().f_223549_() && !client.f_91073_.m_6042_().f_63856_();
    }

    private static double getStartSurfaceY() {
        return Double.isNaN(startSurfaceY) ? TeleportTransitionController.startFeet.f_82480_ : startSurfaceY;
    }
    ...
    private static double getArrivalSurfaceY() {
        ...
        Minecraft client = Minecraft.m_91087_();
        if (feet != null && !Double.isNaN(resolvedSurfaceY = TeleportTransitionController.resolveSkyFacingSurfaceY(client, feet, feet.f_82480_))) {
        ...
        if (feet != null) {
            return TeleportTransitionController.getUnresolvedSkyFacingSurfaceFallbackY(client, feet.f_82480_);
        }
        return TeleportTransitionController.getBestTargetFeet().f_82480_;
    }

    private static Vec3 topDownPos(Vec3 feet, double surfaceY, double altitude) {
        return new Vec3(feet.f_82479_, surfaceY + altitude, feet.f_82481_);
    }
    ...
    private static double getStartBodyCameraHeight() {
        if (Double.isNaN(startBodyCameraHeight)) {
            TeleportTransitionController.updateStartBodyCameraHeights(Minecraft.m_91087_());
        }
    ...
    private static double getArrivalBodyCameraHeight() {
        if (Double.isNaN(arrivalBodyCameraHeight)) {
            TeleportTransitionController.updateArrivalBodyCameraHeights(Minecraft.m_91087_(), TeleportTransitionController.getArrivalCameraFeet());
        }
    ...
    private static BodyCameraHeights resolveBodyCameraHeights(Minecraft client, Vec3 feet) {
        ...
        cameraHeight = Mth.m_14008_((double)cameraHeight, (double)minimumCameraHeight, (double)requestedCameraHeight);
    ...
    private static double getMaxClearBodyCameraHeight(Minecraft client, Vec3 feet, double requestedTopHeight) {
        ...
        double minY = feet.f_82480_ + minHeight;
        double maxY = feet.f_82480_ + requestedTopHeight;
        double lastClearY = minY;
        for (double y = minY; y <= maxY; y += 0.5) {
            Vec3 candidate = new Vec3(feet.f_82479_, y, feet.f_82481_);
            if (TeleportTransitionController.isCameraViewBlocked(client, candidate)) {
                return Math.max(0.0, lastClearY - feet.f_82480_);
            }
            lastClearY = y;
        }
        Vec3 top = new Vec3(feet.f_82479_, maxY, feet.f_82481_);
    ...
    private static double getCameraEyeHeight(Minecraft client) {
        return client == null || client.f_91074_ == null ? 1.62 : (double)client.f_91074_.m_20192_();
    }
    ...
    private static CameraFrame getPostReleaseCameraFrame(float tickProgress) {
        ...
        float progress = Mth.m_14036_((float)((frameTick - (float)postReleaseCameraBlendStartTick) / Math.max(1.0f, (float)postReleaseCameraBlendTicks)), (float)0.0f, (float)1.0f);
    ...
    private static void preparePostReleaseCameraOverride(Minecraft client) {
        ...
        if (!TeleportTransitionController.shouldRespectPreviousCameraPosition() || client == null || client.f_91074_ == null) {
            return;
        }
        if (LEAWIND_THIRD_PERSON_LOADED && client.f_91066_ != null && client.f_91066_.m_92176_() != CameraType.FIRST_PERSON && (resolvedLeawindFrame = TeleportTransitionController.resolveLeawindReleaseCameraFrame(client, client.f_91074_)) != null) {
            CameraFrame playerFrame;
            postReleaseCameraStartFrame = playerFrame = new CameraFrame(client.f_91074_.m_146892_(), client.f_91074_.m_146908_(), client.f_91074_.m_146909_());
        ...
        TeleportTransitionController.captureEnterBodyTarget(client.f_91074_);
        Vec3 pos = enterBodyTargetEye == null ? client.f_91074_.m_146892_() : enterBodyTargetEye;
    ...
    private static void resetLeawindThirdPersonCamera(Minecraft client) {
        ...
        float f = player == null ? (enterBodyTargetEye == null ? startYaw : enterBodyTargetYaw) : (releaseYaw = player.m_146908_());
        float releasePitch = player == null ? (enterBodyTargetEye == null ? startPitch : enterBodyTargetPitch) : player.m_146909_();
        boolean bl = restoreThirdPersonCamera = client != null && client.f_91066_ != null && client.f_91066_.m_92176_() != CameraType.FIRST_PERSON;
        if (!(TeleportTransitionController.resetLeawindCameraAgent("com.github.leawind.thirdperson.ThirdPerson", releasePitch, releaseYaw, restoreThirdPersonCamera) || TeleportTransitionController.resetLeawindCameraAgent("com.github.leawind.thirdperson.impl.ThirdPersonImpl", releasePitch, releaseYaw, restoreThirdPersonCamera) || leawindCameraResetWarningLogged)) {
            ...
            LOGGER.warn("Leawind's Third Person is loaded, but GTP could not reset its CAMERA_AGENT.");
        }
    }

    private static CameraFrame resolveLeawindReleaseCameraFrame(Minecraft client, LocalPlayer player) {
        if (!LEAWIND_THIRD_PERSON_LOADED || client == null || player == null || client.f_91066_ == null || client.f_91066_.m_92176_() == CameraType.FIRST_PERSON) {
            return null;
        }
        float releaseYaw = player.m_146908_();
        float releasePitch = player.m_146909_();
    ...
    private static CameraFrame resolveLeawindReleaseCameraFrame(String className, float pitch, float yaw) {
        try {
            ...
            if (!(rawCamera instanceof Camera) || (camera = (Camera)rawCamera).m_90583_() == null) {
                return null;
            }
            return new CameraFrame(camera.m_90583_(), camera.m_90590_(), camera.m_90589_());
        }
    ...
    private static boolean isPostReleaseCameraSettled(Vec3 vanillaCameraPos, float vanillaYaw, float vanillaPitch) {
        if (vanillaCameraPos == null || postReleaseCameraFrame == null || vanillaCameraPos.m_82557_(postReleaseCameraFrame.pos()) > 0.01) {
            return false;
        }
    ...
    public static void requestTerrainVisibilityUpdate(Vec3 cameraPos) {
        ...
        Minecraft client = Minecraft.m_91087_();
        if (client == null || client.f_91073_ == null || client.f_91060_ == null) {
            return;
        }
        int sectionX = Mth.m_14107_((double)(cameraPos.f_82479_ / 16.0));
        int sectionY = Mth.m_14107_((double)(cameraPos.f_82480_ / 16.0));
        int sectionZ = Mth.m_14107_((double)(cameraPos.f_82481_ / 16.0));
    ...
    public static boolean shouldUseGroundSkyBackground() {
        Minecraft client = Minecraft.m_91087_();
        return TeleportTransitionController.shouldForceTerrainFrustumApply() && client != null && client.f_91073_ != null && client.f_91073_.m_6042_().f_223549_() && !client.f_91073_.m_6042_().f_63856_();
    }
    ...
    public static boolean shouldRetainDepartingChunk(int chunkX, int chunkZ) {
        ...
        int startChunkX = Mth.m_14107_((double)TeleportTransitionController.startFeet.f_82479_) >> 4;
        int startChunkZ = Mth.m_14107_((double)TeleportTransitionController.startFeet.f_82481_) >> 4;
        int radius = TeleportTransitionController.getRetainedDepartingChunkRadius(Minecraft.m_91087_());
    ...
    public static float getFallbackTerrainSectionVisibility(BlockPos renderOrigin) {
        return TeleportTransitionController.getFallbackTerrainSectionVisibility((double)renderOrigin.m_123341_() + 8.0, (double)renderOrigin.m_123342_() + 8.0, (double)renderOrigin.m_123343_() + 8.0);
    }
    ...
    private static void updateSkipTravelTargetDimensionTicks(Minecraft client) {
        ...
        if (TeleportTransitionController.isInPlannedTargetDimension(client)) {
            if (++skipTravelTargetDimensionTicks == 1 && client.f_91074_ != null) {
                LOGGER.info("GTP cross-dimension target level visible: targetDim={} playerFeet={} plannedTargetFeet={}", new Object[]{plannedTargetDimensionId, TeleportTransitionController.getFeetPos(client.f_91074_), plannedTargetFeet});
            }
        } else {
            skipTravelTargetDimensionTicks = 0;
        }
    ...
    private static void closeSkipTravelLoadingTerrainScreen(Minecraft client) {
        if (!skipTravel || client == null || !(client.f_91080_ instanceof ReceivingLevelScreen)) {
            return;
        }
    ...
    private static boolean hasUsableSkipTravelArrivalFeet(Minecraft client) {
        return skipTravelTargetDimensionTicks >= 3 && TeleportTransitionController.isInPlannedTargetDimension(client) && client != null && client.f_91074_ != null;
    }
    ...
    private static boolean isArrivalSurfaceReady(Minecraft client) {
        ...
        Vec3 feet = TeleportTransitionController.getArrivalCameraFeet();
        return feet != null && !Double.isNaN(TeleportTransitionController.resolveSkyFacingSurfaceY(client, feet, feet.f_82480_));
    }

    private static boolean isInPlannedTargetDimension(Minecraft client) {
        return plannedTargetDimensionId != null && client != null && client.f_91073_ != null && plannedTargetDimensionId.equals(DimensionIds.fromResourceKey(client.f_91073_.m_46472_()));
    }
    ...
    private static boolean isNearPlannedTarget(Vec3 playerFeet) {
        ...
        double dx = playerFeet.f_82479_ - TeleportTransitionController.plannedTargetFeet.f_82479_;
        double dz = playerFeet.f_82481_ - TeleportTransitionController.plannedTargetFeet.f_82481_;
        double dy = Math.abs(playerFeet.f_82480_ - TeleportTransitionController.plannedTargetFeet.f_82480_);
        return dx * dx + dz * dz <= 16.0 && dy <= 8.0;
    }

    private static boolean hasTeleportedSinceLastObservation(Vec3 playerFeet) {
        return lastObservedPlayerFeet != null && playerFeet.m_82557_(lastObservedPlayerFeet) > 9.0;
    }
    ...
    private static int calculateTravelTicks(Vec3 fromFeet, Vec3 toFeet) {
        ...
        double dx = toFeet.f_82479_ - fromFeet.f_82479_;
        double dz = toFeet.f_82481_ - fromFeet.f_82481_;
        double horizontalDistance = Math.sqrt(dx * dx + dz * dz);
        int scaledTicks = Mth.m_14165_((double)(horizontalDistance / 30.0));
        return Mth.m_14045_((int)scaledTicks, (int)20, (int)60);
    }
    ...
    private static void recordActualTargetFeet(Vec3 playerFeet) {
        ...
        if (!Double.isNaN(resolvedArrivalSurfaceY = TeleportTransitionController.resolveSkyFacingSurfaceY(Minecraft.m_91087_(), playerFeet, playerFeet.f_82480_))) {
            arrivalSurfaceY = resolvedArrivalSurfaceY;
        }
        TeleportTransitionController.updateArrivalBodyCameraHeights(Minecraft.m_91087_(), playerFeet);
        if (skipTravel) {
    ...
    private static CameraFrame exitBodyFrame(float progress) {
        ...
        Vec3 source = startEye == null ? startFeet.m_82520_(0.0, 1.6, 0.0) : startEye;
        Vec3 target = startFeet.m_82520_(0.0, TeleportTransitionController.getStartBodyCameraHeight(), 0.0);
    ...
    private static CameraFrame enterBodyHoldFrame(float frameTick) {
        TeleportTransitionController.lockArrivalBodyCameraHeightsForEnter(Minecraft.m_91087_());
    ...
    private static CameraFrame bodyHoldFrame(Vec3 feet, float yaw, double altitude) {
        return new CameraFrame(feet.m_82520_(0.0, altitude, 0.0), yaw, 90.0f);
    }
    ...
    private static CameraFrame travelFrame(float progress, float frameTick) {
        ...
        Vec3 pos = source.m_165921_(target, (double)TeleportTransitionController.travelEaseProgress(progress));
        return TeleportTransitionController.applyZoomShake(pos, startYaw, 90.0f, frameTick, 1.0f);
    }
    ...
    private static float travelEaseProgress(float progress) {
        ...
        double elapsed = (double)Mth.m_14036_((float)progress, (float)0.0f, (float)1.0f) * total;
    ...
    private static double integratedSmoothStep(double value) {
        double x = Mth.m_14008_((double)value, (double)0.0, (double)1.0);
    ...
    private static CameraFrame enterBodyFrame(LocalPlayer player, float progress) {
        ...
        float horizontalProgress = TeleportTransitionController.shouldRespectPreviousCameraPosition() ? TeleportTransitionController.perspectiveHorizontalProgress(progress) : heightProgress;
        float lookProgress = TeleportTransitionController.bodyLookProgress(progress);
        Vec3 source = TeleportTransitionController.getArrivalCameraFeet().m_82520_(0.0, TeleportTransitionController.getArrivalBodyCameraHeight(), 0.0);
        Vec3 target = enterBodyTargetEye == null ? player.m_146892_() : enterBodyTargetEye;
    ...
    private static void captureEnterBodyTarget(LocalPlayer player) {
        ...
        if (TeleportTransitionController.shouldRespectPreviousCameraPosition() && LEAWIND_THIRD_PERSON_LOADED) {
            ...
            enterBodyTargetYaw = player.m_146908_();
            enterBodyTargetPitch = player.m_146909_();
            return;
        }
        ...
        if (TeleportTransitionController.shouldRespectPreviousCameraPosition()) {
            ...
            if (camera != null && liveCameraPos != null) {
                enterBodyTargetYaw = camera.m_90590_();
                enterBodyTargetPitch = camera.m_90589_();
                return;
            }
    ...
    private static Vec3 getLeawindPreviousCameraPosition(LocalPlayer player, Vec3 playerEye) {
        ...
        if (!Double.isFinite(distance) || distance <= 0.1) {
            distance = startCameraEyeOffset == null ? 4.0 : Mth.m_14008_((double)startCameraEyeOffset.m_82553_(), (double)1.0, (double)12.0);
        }
        Vec3 forward = TeleportTransitionController.getCameraForwardVector(player.m_146908_(), player.m_146909_());
        return TeleportTransitionController.clipCameraOffset(Minecraft.m_91087_(), player, playerEye, forward.m_82490_(-distance));
    }
    ...
    private static Vec3 getPreservedPerspectiveCameraOffset(LocalPlayer player) {
        ...
        double offsetLengthSqr = startCameraEyeOffset.m_82556_();
        if (!Double.isFinite(offsetLengthSqr) || offsetLengthSqr < 0.01 || offsetLengthSqr > 576.0) {
            return null;
        }
        return TeleportTransitionController.rotateHorizontalOffset(startCameraEyeOffset, player.m_146908_() - startPlayerYaw);
    }
    ...
    private static Vec3 rotateHorizontalOffset(Vec3 offset, float yawDegrees) {
        ...
        double x = offset.f_82479_ * cos - offset.f_82481_ * sin;
        double z = offset.f_82479_ * sin + offset.f_82481_ * cos;
        return new Vec3(x, offset.f_82480_, z);
    }
    ...
    private static Vec3 getVanillaPreviousCameraPosition(LocalPlayer player, Vec3 playerEye) {
        ...
        double zoom = TeleportTransitionController.getMaxThirdPersonZoom(Minecraft.m_91087_(), player, playerEye, forward, 4.0);
        return playerEye.m_82546_(forward.m_82490_(zoom));
    }
    ...
    private static Vec3 getCameraForwardVector(float yaw, float pitch) {
        ...
        float cosPitch = Mth.m_14089_((float)pitchRadians);
        return new Vec3((double)(-Mth.m_14031_((float)yawRadians) * cosPitch), (double)(-Mth.m_14031_((float)pitchRadians)), (double)(Mth.m_14089_((float)yawRadians) * cosPitch));
    }
    ...
    private static double getMaxThirdPersonZoom(Minecraft client, LocalPlayer player, Vec3 playerEye, Vec3 forward, double requestedZoom) {
        if (client == null || client.f_91073_ == null || player == null || playerEye == null || forward == null) {
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            Vec3 from = playerEye.m_82520_(xOffset, yOffset, zOffset);
            BlockHitResult hit = client.f_91073_.m_45547_(new ClipContext(from, to = from.m_82546_(forward.m_82490_(requestedZoom)), ClipContext.Block.VISUAL, ClipContext.Fluid.NONE, (Entity)player));
            if (hit.m_6662_() == HitResult.Type.MISS || !((hitDistance = hit.m_82450_().m_82554_(playerEye)) < zoom)) continue;
            zoom = hitDistance;
        }
        return Mth.m_14008_((double)zoom, (double)0.0, (double)requestedZoom);
    }

    private static Vec3 clipCameraOffset(Minecraft client, LocalPlayer player, Vec3 playerEye, Vec3 offset) {
        Vec3 target;
        if (client == null || client.f_91073_ == null || player == null || playerEye == null || offset == null || offset.m_82556_() < 1.0E-6) {
            return playerEye.m_82549_(offset == null ? Vec3.f_82478_ : offset);
        }
        Vec3 clipped = target = playerEye.m_82549_(offset);
        for (int i = 0; i < 8; ++i) {
            Vec3 to;
            double xOffset = (double)((i & 1) * 2 - 1) * 0.1;
            double yOffset = (double)((i >> 1 & 1) * 2 - 1) * 0.1;
            double zOffset = (double)((i >> 2 & 1) * 2 - 1) * 0.1;
            Vec3 from = playerEye.m_82520_(xOffset, yOffset, zOffset);
            BlockHitResult hit = client.f_91073_.m_45547_(new ClipContext(from, to = target.m_82520_(xOffset, yOffset, zOffset), ClipContext.Block.VISUAL, ClipContext.Fluid.NONE, (Entity)player));
            if (hit.m_6662_() == HitResult.Type.MISS || !(hit.m_82450_().m_82557_(playerEye) < clipped.m_82557_(playerEye))) continue;
            clipped = hit.m_82450_();
        }
        return clipped;
    }
    ...
    private static Camera getCurrentCamera() {
        Minecraft client = Minecraft.m_91087_();
        return client == null || client.f_91063_ == null ? null : client.f_91063_.m_109153_();
    }

    private static Vec3 getCurrentCameraPosition(Vec3 playerEye) {
        Camera camera = TeleportTransitionController.getCurrentCamera();
        if (camera == null || camera.m_90583_() == null || playerEye == null) {
            return null;
        }
        Vec3 cameraPos = camera.m_90583_();
        return cameraPos.m_82557_(playerEye) <= 64.0 ? cameraPos : null;
    }
    ...
    private static Vec3 getInitialTransitionCameraPosition(Minecraft client, Vec3 fallback) {
        if (client == null || client.f_91063_ == null) {
            return fallback;
        }
        Camera camera = client.f_91063_.m_109153_();
        return camera == null || camera.m_90583_() == null ? fallback : camera.m_90583_();
    }

    private static float getInitialTransitionYaw(Minecraft client, LocalPlayer player) {
        if (!TeleportTransitionController.shouldUseStoredPerspectiveCamera() || client == null || client.f_91063_ == null) {
            return player.m_146908_();
        }
        Camera camera = client.f_91063_.m_109153_();
        return camera == null ? player.m_146908_() : camera.m_90590_();
    }
    ...
    private static float getInitialTransitionPitch(Minecraft client, LocalPlayer player) {
        ...
        Camera camera = client.f_91063_.m_109153_();
        return camera == null ? player.m_146909_() : camera.m_90589_();
    }
    ...
    private static Vec3 getLiveSkipTravelArrivalFeet() {
        ...
        return TeleportTransitionController.getFeetPos(client.f_91074_);
    }
    ...
    private static CameraFrame applyZoomShake(Vec3 pos, float yaw, float pitch, float frameTick, float envelope) {
        double easedEnvelope = Mth.m_14036_((float)envelope, (float)0.0f, (float)1.0f);
        ...
        double pitchShake = (Mth.m_14008_((double)verticalWave, (double)-1.0, (double)1.0) - 1.0) * 0.5 * 1.05 * easedEnvelope;
        double yawShake = horizontalWave * 0.15 * easedEnvelope;
        float shakenYaw = yaw + (float)yawShake;
        float shakenPitch = Mth.m_14036_((float)(pitch + (float)pitchShake), (float)-90.0f, (float)90.0f);
    ...
    private static GtaLikeTeleportConfig.ZoomDimension getCurrentZoomDimension() {
        Minecraft client = Minecraft.m_91087_();
        ResourceKey dimension = client.f_91073_ == null ? startDimension : client.f_91073_.m_46472_();
    ...
    private static double linearThenEaseOut(float value) {
        double x = Mth.m_14036_((float)value, (float)0.0f, (float)1.0f);
    ...
    private static Vec3 lerpPerspectiveCameraPosition(Vec3 source, Vec3 target, float verticalProgress, float horizontalProgress) {
        double x = Mth.m_14139_((double)Mth.m_14036_((float)horizontalProgress, (float)0.0f, (float)1.0f), (double)source.f_82479_, (double)target.f_82479_);
        double y = Mth.m_14139_((double)Mth.m_14036_((float)verticalProgress, (float)0.0f, (float)1.0f), (double)source.f_82480_, (double)target.f_82480_);
        double z = Mth.m_14139_((double)Mth.m_14036_((float)horizontalProgress, (float)0.0f, (float)1.0f), (double)source.f_82481_, (double)target.f_82481_);
    ...
    private static double hermiteEaseOutFromLinear(double x, double decelStart, double linearSpeed) {
        ...
        return Mth.m_14008_((double)(h00 * y0 + h10 * m0 + h01), (double)0.0, (double)1.0);
    }
    ...
    private static float smoothStep(float value) {
        float x = Mth.m_14036_((float)value, (float)0.0f, (float)1.0f);
        return x * x * (3.0f - 2.0f * x);
    }

    private static float lerpFloat(float from, float to, float progress) {
        float x = Mth.m_14036_((float)progress, (float)0.0f, (float)1.0f);
        return from + (to - from) * x;
    }

    private static float bodyLookProgress(float progress) {
        return TeleportTransitionController.easeOutCubic(Mth.m_14036_((float)(progress * 1.5f), (float)0.0f, (float)1.0f));
    }
    ...
    private static float lerpDegrees(float from, float to, float progress) {
        return from + TeleportTransitionController.wrapDegrees(to - from) * Mth.m_14036_((float)progress, (float)0.0f, (float)1.0f);
    }
    ...
    private static void playStepSound(Minecraft client, int tick) {
        ...
        TeleportTransitionController.playUiSound(client, SoundEvents.f_12376_, TeleportTransitionController.minecraftSoundVolume(0.86f), 1.0f);
    }
    ...
    private static void playTravelSound(Minecraft client) {
        if (GtaLikeTeleportConfig.isCustomSoundsEnabled()) {
            ...
            client.m_91106_().m_120367_((SoundInstance)activeTravelSound);
            return;
        }
        TeleportTransitionController.playUiSound(client, SoundEvents.f_12288_, TeleportTransitionController.minecraftSoundVolume(0.48f), 1.0f);
    }
    ...
    private static void playBodyTransitionSound(Minecraft client, boolean enteringPlayer) {
        ...
        for (int i = 0; i < 3; ++i) {
            TeleportTransitionController.playUiSound(client, SoundEvents.f_12498_, TeleportTransitionController.minecraftSoundVolume(1.0f), 0.8f);
        }
    }
    ...
    private static void playUiSound(Minecraft client, SoundEvent sound, float volume, float pitch) {
        client.m_91106_().m_120367_((SoundInstance)SimpleSoundInstance.m_119755_((SoundEvent)sound, (float)pitch, (float)volume));
    }
    ...
    private static void stopCustomTravelSound(Minecraft client) {
        if (activeTravelSound != null) {
            client.m_91106_().m_120399_((SoundInstance)activeTravelSound);
    ...
    private static float cubicBezierEase(float progress) {
        float x;
        float t = x = Mth.m_14036_((float)progress, (float)0.0f, (float)1.0f);
        for (int i = 0; i < 5; ++i) {
            ...
            t = Mth.m_14036_((float)(t - (currentX - x) / derivative), (float)0.0f, (float)1.0f);
        }
    ...
    private static int getCommandSendTravelHoldTicks() {
        return Mth.m_14045_((int)(travelTicks / 2), (int)10, (int)24);
    }
    ...
    private static boolean areArrivalChunksReady(Minecraft client) {
        ...
        int centerChunkX = Mth.m_14107_((double)feet.f_82479_) >> 4;
        if (!client.f_91073_.m_7232_(centerChunkX, centerChunkZ = Mth.m_14107_((double)feet.f_82481_) >> 4)) {
            return false;
        }
        ...
        for (int dz = -radius; dz <= radius; ++dz) {
            for (int dx = -radius; dx <= radius; ++dx) {
                ++total;
                if (!client.f_91073_.m_7232_(centerChunkX + dx, centerChunkZ + dz)) continue;
                ++loaded;
            }
        }
    ...
    private static int getNormalChunkHandoffReadyRadius(Minecraft client) {
        int renderDistance = client.f_91066_ == null ? 12 : client.f_91066_.m_193772_();
        return Math.min(4, Math.max(2, renderDistance / 3));
    }

    private static int getRetainedDepartingChunkRadius(Minecraft client) {
        int renderDistance = client == null || client.f_91066_ == null ? 12 : client.f_91066_.m_193772_();
    ...
    private static void updateBodyTransitionTicks(Minecraft client) {
        int ticks;
        Vec3 exitTarget = startFeet == null ? null : startFeet.m_82520_(0.0, TeleportTransitionController.getStartBodyCameraHeight(), 0.0);
    ...
    private static int calculateBodyTransitionTicks(Minecraft client, Vec3 source, Vec3 target) {
        ...
        double verticalDistance = Math.abs(target.f_82480_ - source.f_82480_);
        double horizontalDistance = Math.hypot(target.f_82479_ - source.f_82479_, target.f_82481_ - source.f_82481_);
        ...
        int scaledTicks = Mth.m_14165_((double)(12.0 * distance / baseDistance));
        return Mth.m_14045_((int)scaledTicks, (int)12, (int)24);
    }
    ...
    private static float getDistanceOrderTowardPoint(double sectionCenterX, double sectionCenterZ, Vec3 centerFeet, Vec3 directionFeet) {
        ...
        return (float)Mth.m_14008_((double)((distance - min) / Math.max(1.0, max - min)), (double)0.0, (double)1.0);
    }

    private static float getShaderMaskSweepThreshold(float order) {
        return Mth.m_14036_((float)order, (float)0.0f, (float)1.0f) * 0.78f;
    }
    ...
    private static double horizontalDistance(Vec3 from, Vec3 to) {
        ...
        double dx = from.f_82479_ - to.f_82479_;
        double dz = from.f_82481_ - to.f_82481_;
    ...
    private static double horizontalDistance(double x, double z, Vec3 to) {
        ...
        double dx = x - to.f_82479_;
        double dz = z - to.f_82481_;
        return Math.sqrt(dx * dx + dz * dz);
    }
    ...
    private static void syncCameraStateBeforeRelease(Minecraft client) {
        ...
        TeleportTransitionController.captureEnterBodyTarget(client.f_91074_);
        if (!TeleportTransitionController.shouldRespectPreviousCameraPosition()) {
            TeleportTransitionController.syncPlayerLook(client.f_91074_, enterBodyTargetYaw, enterBodyTargetPitch);
        }
        TeleportTransitionController.syncPlayerInterpolationState(client.f_91074_);
    }
    ...
    private static void syncPlayerLook(LocalPlayer player, float yaw, float pitch) {
        float clampedPitch = Mth.m_14036_((float)pitch, (float)-90.0f, (float)90.0f);
        player.m_146922_(yaw);
        player.m_146926_(clampedPitch);
        player.m_5616_(yaw);
        player.m_5618_(yaw);
    }
    ...
    private static void restoreCameraType(Minecraft client) {
        if (previousCameraType != null) {
            client.f_91066_.m_92157_(previousCameraType);
        }
    }

    private static void restoreSmartCull(Minecraft client) {
        if (client.f_90980_ != previousSmartCull) {
            client.f_90980_ = previousSmartCull;
            client.f_91060_.m_109826_();
        }
    }
    ...
    private static void updateHudVisibility(Minecraft client) {
        if (!hudSuppressed && ticks >= 8) {
            client.f_91066_.f_92062_ = true;
            hudSuppressed = true;
        }
        if (hudSuppressed && cameraReleased) {
            client.f_91066_.f_92062_ = previousHudHidden;
            hudSuppressed = false;
        }
    }
    ...
    private static void releaseRetainedDepartingChunks(Minecraft client) {
        ...
        if (client != null && client.f_91073_ != null) {
            int playerChunkX = client.f_91074_ == null ? Integer.MIN_VALUE : Mth.m_14107_((double)client.f_91074_.m_20185_()) >> 4;
            int playerChunkZ = client.f_91074_ == null ? Integer.MIN_VALUE : Mth.m_14107_((double)client.f_91074_.m_20189_()) >> 4;
            int keepRadius = client.f_91066_ == null ? 12 : client.f_91066_.m_193772_() + 1;
            for (long key : retainedDepartingChunks) {
                ...
                client.f_91073_.m_7726_().m_104455_(chunkX, chunkZ);
            }
        }
        retainedDepartingChunks.clear();
    }
    ...
    extends AbstractTickableSoundInstance {
        ...
        private FadingTravelSound(float volume) {
            super(TeleportSounds.TELEPORT, SoundSource.PLAYERS, SoundInstance.m_235150_());
        ...
        public void m_7788_() {
            ...
            this.f_119573_ = this.baseVolume * ((float)this.fadeTicksRemaining / (float)this.fadeTicks);
