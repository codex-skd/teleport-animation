...
Ejemplo: `26.2-neoforge-0.0.0-beta.16`
...
<p><strong>JAR</strong>: <code>teleport_animation-26.2-neoforge-&lt;version&gt;.jar</code></p>
```
...
with open(f"build/libs/teleport_animation-26.2-neoforge-{version}.jar", "rb") as f:
    jar_data = f.read()
...
body += meta_bytes + b"\r\n"
body += f"--{boundary}\r\n".encode()
body += f'Content-Disposition: form-data; name="file"; filename="teleport_animation-26.2-neoforge-{version}.jar"\r\n'.encode()
