...
|---|---|---|
| WORKFLOW | `WORKFLOW_<MOD_ID>_<MC-VERSION>.md` | `WORKFLOW_TELEPORT_ANIMATION_26-2.md` |
...
├── docs/
│   ├── WORKFLOW_TELEPORT_ANIMATION_26-2.md  # Este documento
...
| Ejemplo | Significado |
|---------|-------------|
| `teleport_animation-26.2-neoforge-0.0.0-beta.15.jar` | NeoForge 26.2, beta 15 |
...
|--------|---------|---------|
| Beta | `<mc-version>-neoforge-beta.X` | `26.2-neoforge-beta.21` |
...
```bash
# Beta
git tag -a 26.2-neoforge-beta.21 -m "v0.0.0-beta.21: Update WORKFLOW.md"
git push origin 26.2-neoforge-beta.21
