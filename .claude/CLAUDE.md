...
1. **Trabaja con `docs/WORKFLOW_TELEPORT_ANIMATION_1-21-1.md`** — es el workflow operativo de este mod, autocontenido. Léelo y síguelo. No hay que actualizarlo por sesión.
...
3. Workflow del proyecto (`docs/WORKFLOW_TELEPORT_ANIMATION_1-21-1.md`).
