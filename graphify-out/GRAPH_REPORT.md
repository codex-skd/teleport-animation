...
## Corpus Check
- 87 files · ~95,699 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 975 nodes · 2111 edges · 82 communities (71 shown, 11 thin omitted)
...
Cohesion: 0.07
Nodes (25): IEventBus, MinecraftServer, Mod, RegisterPayloadHandlersEvent, EntityMixin, CallbackInfoReturnable, Entity, Inject (+17 more)
...
Cohesion: 0.06
Nodes (33): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+25 more)
...
### Community 53 - ".tick"
Cohesion: 0.20
Nodes (7): AbstractTickableSoundInstance, BodyCameraHeights, FadingTravelSound, Camera, Level, Logger, ResourceKey
...
## Knowledge Gaps
- **115 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `0.0.0-beta.29 (2026-07-22)`, `0.0.0-beta.28 (2026-07-22)` (+110 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `TeleportTransitionController.java`, `.isRunning`, `.handleWarpPlateTeleport`, `TeleportClient`, `LocalPlayer`, `.getCameraFrame`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `ZoomDimension`, `.enterBodyFrame`, `FrustumMixin.java`, `ScreenEffectRendererMixin.java`, `.tick`, `EntityMixin.java`, `LeawindThirdPersonImplMixin.java`, `.shouldPreferVoxyOnlyTerrain`, `DistantHorizonsRenderUtilMixin.java`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `TeleportServer`, `TeleportClient`, `.save`, `.applyConfigProperties`, `ZoomDimension`, `.clamp`, `LeawindThirdPersonImplMixin.java`, `ScreenEffectRendererMixin.java`, `.load`?**
