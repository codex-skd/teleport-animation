...
## Corpus Check
- 83 files · ~95,499 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 982 nodes · 2128 edges · 76 communities (64 shown, 12 thin omitted)
...
Cohesion: 0.09
Nodes (17): ComputeCameraAngles, Invoker, CameraAccessor, Mixin, Vec3, CameraMixin, CallbackInfo, CameraRenderState (+9 more)
...
Cohesion: 0.05
Nodes (39): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+31 more)
...
### Community 53 - ".tick"
Cohesion: 0.22
Nodes (6): AbstractTickableSoundInstance, FadingTravelSound, Camera, Level, Logger, ResourceKey
...
Cohesion: 0.12
Nodes (16): Method, IrisCompat, CallbackInfo, Entity, Inject, ItemStack, Mixin, Pseudo (+8 more)
...
## Knowledge Gaps
- **122 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `0.0.0-beta.35 (2026-07-24)`, `0.0.0-beta.34 (2026-07-24)` (+117 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `TeleportTransitionController.java`, `.isRunning`, `StartServerTeleportPayload`, `.handleWarpPlateTeleport`, `TeleportClient`, `LocalPlayer`, `TeleportTransitionController`, `LevelRendererMixin.java`, `.getCameraFrame`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.enterBodyFrame`, `MinecraftMixin.java`, `.tick`, `ScreenEffectRendererMixin.java`, `.shouldPreferVoxyOnlyTerrain`, `LeawindThirdPersonImplMixin.java`?**
  _High betweenness centrality (0.297) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `StartServerTeleportPayload`, `TeleportClient`, `TeleportTransitionController`, `.save`, `.applyConfigProperties`, `ZoomDimension`, `.clamp`, `LeawindThirdPersonImplMixin.java`, `.load`?**
