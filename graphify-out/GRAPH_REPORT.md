...
## Corpus Check
- 83 files · ~95,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 965 nodes · 2095 edges · 74 communities (62 shown, 12 thin omitted)
...
- `TeleportTransitionController` --references--> `Vec3`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 28 → community 6_
- `CameraFrame` --references--> `Vec3`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 6 → community 15_
...
Cohesion: 0.07
Nodes (29): IEventBus, Method, MinecraftServer, Mod, RegisterPayloadHandlersEvent, CallbackInfo, Entity, Inject (+21 more)
...
Cohesion: 0.06
Nodes (23): CustomPacketPayload, FriendlyByteBuf, Identifier, Override, Vec3, TeleportClientNetworking, BypassNextServerTeleportPayload, Level (+15 more)
...
Cohesion: 0.06
Nodes (31): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+23 more)
...
### Community 53 - ".tick"
Cohesion: 0.17
Nodes (7): AbstractTickableSoundInstance, FadingTravelSound, Camera, Level, Logger, ResourceKey, VoxyCompat
...
## Knowledge Gaps
- **113 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `0.0.0-beta.27 (2026-07-22)`, `0.0.0-beta.26 (2026-07-22)` (+108 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `.shouldPreferVoxyOnlyTerrain`, `.isRunning`, `TeleportTransitionController.java`, `.handleWarpPlateTeleport`, `TeleportClient`, `LocalPlayer`, `LeawindThirdPersonImplMixin.java`, `LevelRendererMixin.java`, `.getCameraFrame`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.tick`, `EntityMixin.java`, `.enterBodyFrame`, `FrustumMixin.java`, `ScreenEffectRendererMixin.java`?**
  _High betweenness centrality (0.307) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `TeleportServer`, `.handleWarpPlateTeleport`, `TeleportClient`, `.save`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.applyConfigProperties`, `ZoomDimension`, `.clamp`, `FrustumMixin.java`, `ScreenEffectRendererMixin.java`, `.load`?**
