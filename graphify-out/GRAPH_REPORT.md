...
## Corpus Check
- 97 files · ~96,821 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 984 nodes · 1872 edges · 175 communities (74 shown, 101 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f7dbfe91`
...
- `TeleportTransitionController` --references--> `Level`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 28 → community 77_
...
## Communities (175 total, 101 thin omitted)

### Community 1 - "TeleportServer"
Cohesion: 0.08
Nodes (16): IEventBus, MinecraftServer, Mod, RegisterPayloadHandlersEvent, EntityMixin, WaystonesWarpPlateBlockEntityMixin, TeleportAnimation, Level (+8 more)
...
Cohesion: 0.06
Nodes (5): LocalPlayer, SodiumCompat, Camera, Minecraft, Vec3

### Community 13 - "Changelog"
Cohesion: 0.04
Nodes (48): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+40 more)
...
Cohesion: 0.06
Nodes (6): GuiGraphicsExtractor, IrisCompat, GameRendererMixin, GuiMixin, TeleportStepEffectRenderer, BlockPos
...
Cohesion: 0.14
Nodes (12): ClientLevel, ClientLevelData, Frustum, LevelHeightAccessor, Redirect, EntityRendererMixin, CallbackInfoReturnable, Inject (+4 more)
...
Cohesion: 0.21
Nodes (6): Method, BobbyCompat, Level, Logger, ResourceKey, VoxyCompat

## Knowledge Gaps
- **143 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `GameRendererMixin`, `GuiMixin` (+138 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `TeleportTransitionController.java`, `.isRunning`, `TeleportClient`, `LocalPlayer`, `LevelRendererMixin.java`, `.getCameraFrame`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `FrustumMixin.java`, `MinecraftMixin.java`, `MinecraftMixin.java`, `ScreenEffectRendererMixin.java`, `.tick`, `DistantHorizonsCompat.java`, `VoxyCompat.java`, `Inject`, `Mixin`, `CallbackInfoReturnable`?**
  _High betweenness centrality (0.242) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `TeleportClient`, `LocalPlayer`, `IrisCompat`, `DistantHorizonsCompat.java`, `.save`, `.getPullEndTick`, `.applyConfigProperties`, `.tick`, `ZoomDimension`, `.clamp`, `MinecraftMixin.java`, `.load`?**
