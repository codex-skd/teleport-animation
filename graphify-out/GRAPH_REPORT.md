...
## Corpus Check
- 97 files · ~96,794 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 983 nodes · 1871 edges · 177 communities (73 shown, 104 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `345d9c36`
...
- `TeleportTransitionController` --references--> `FadingTravelSound`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java → src/main/java/com/skd/teleport_animation/TeleportTransitionController.java  _Bridges community 28 → community 20_
- `TeleportTransitionController` --references--> `Vec3`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 28 → community 14_
- `CameraFrame` --references--> `Vec3`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 14 → community 15_

## Import Cycles
- None detected.

## Communities (177 total, 104 thin omitted)

### Community 1 - "TeleportServer"
Cohesion: 0.10
Nodes (14): IEventBus, MinecraftServer, Mod, RegisterPayloadHandlersEvent, EntityMixin, TeleportAnimation, Level, Logger (+6 more)

### Community 3 - ".isRunning"
Cohesion: 0.10
Nodes (9): ComputeCameraAngles, Invoker, CameraAccessor, CameraMixin, CallbackInfo, DeltaTracker, Inject, Mixin (+1 more)

### Community 5 - "StartServerTeleportPayload"
Cohesion: 0.08
Nodes (13): CustomPacketPayload, FriendlyByteBuf, Identifier, Override, TeleportClientNetworking, BypassNextServerTeleportPayload, ServerTeleportAckPayload, StartServerTeleportPayload (+5 more)
...
Cohesion: 0.04
Nodes (47): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+39 more)
...
Cohesion: 0.07
Nodes (11): ClientLevel, ClientLevelData, GuiGraphicsExtractor, LevelHeightAccessor, Redirect, FogRendererMixin, GameRendererMixin, GuiMixin (+3 more)

### Community 20 - "KeyboardInputMixin.java"
Cohesion: 0.12
Nodes (9): AbstractTickableSoundInstance, DistantHorizonsRenderUtilMixin, LeawindThirdPersonLegacyMixin, FadingTravelSound, BlockPos, Camera, Level, Logger (+1 more)
...
Cohesion: 0.48
Nodes (5): Frustum, EntityRendererMixin, CallbackInfoReturnable, Inject, Mixin
...
### Community 76 - "DistantHorizonsCompat.java"
Cohesion: 0.21
Nodes (3): MouseButtonInfo, KeyboardInputMixin, MouseHandlerMixin

### Community 77 - "VoxyCompat.java"
Cohesion: 0.20
Nodes (3): Method, BobbyCompat, DistantHorizonsCompat

## Knowledge Gaps
- **142 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `GameRendererMixin`, `GuiMixin` (+137 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `TeleportTransitionController.java`, `.isRunning`, `TeleportClient`, `LocalPlayer`, `IrisCompat`, `DistantHorizonsCompat.java`, `LevelRendererMixin.java`, `.getCameraFrame`, `WaystonesTeleportHandler`, `MinecraftMixin.java`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.tick`, `ScreenEffectRendererMixin.java`, `ZoomDimension`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `Logger`, `TeleportServer`, `TeleportTransitionController.java`, `TeleportClient`, `IrisCompat`, `DistantHorizonsCompat.java`, `WaystonesTeleportHandler`, `.save`, `.getPullEndTick`, `.applyConfigProperties`, `.tick`, `ZoomDimension`, `.clamp`, `Inject`, `.load`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `TeleportClient` connect `TeleportClient` to `WaystonesTeleportHandler`, `TeleportServer`, `StartServerTeleportPayload`?**
