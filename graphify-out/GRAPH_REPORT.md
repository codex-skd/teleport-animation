...
## Corpus Check
- 82 files · ~95,392 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 978 nodes · 2123 edges · 71 communities (63 shown, 8 thin omitted)
...
- `TeleportTransitionController` --references--> `Vec3`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 28 → community 10_
- `CameraFrame` --references--> `Vec3`  [EXTRACTED]
  src/main/java/com/skd/teleport_animation/TeleportTransitionController.java →   _Bridges community 10 → community 15_
...
Cohesion: 0.14
Nodes (6): Frustum, LocalPlayer, EntityRendererMixin, CallbackInfoReturnable, Inject, Mixin
...
Cohesion: 0.05
Nodes (38): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+30 more)
...
Cohesion: 0.08
Nodes (8): GuiGraphicsExtractor, IrisCompat, GameRendererMixin, Mixin, GuiMixin, Mixin, Vec3, TeleportStepEffectRenderer
...
### Community 53 - ".tick"
Cohesion: 0.06
Nodes (24): AbstractTickableSoundInstance, ClientLevel, BobbyCompat, DistantHorizonsRenderUtilMixin, CallbackInfoReturnable, Inject, Mixin, Pseudo (+16 more)
...
Cohesion: 0.09
Nodes (18): Method, DistantHorizonsCompat, CallbackInfo, Entity, Inject, ItemStack, Mixin, Pseudo (+10 more)
...
## Knowledge Gaps
- **121 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `0.0.0-beta.34 (2026-07-24)`, `0.0.0-beta.33 (2026-07-24)` (+116 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `TeleportTransitionController.java`, `.isRunning`, `StartServerTeleportPayload`, `.handleWarpPlateTeleport`, `TeleportClient`, `LocalPlayer`, `TeleportTransitionController`, `LevelRendererMixin.java`, `.getCameraFrame`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.enterBodyFrame`, `FrustumMixin.java`, `MinecraftMixin.java`, `.tick`, `ScreenEffectRendererMixin.java`, `.shouldPreferVoxyOnlyTerrain`, `LeawindThirdPersonImplMixin.java`, `FogRendererMixin.java`?**
  _High betweenness centrality (0.299) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `Minecraft`, `TeleportServer`, `StartServerTeleportPayload`, `TeleportClient`, `.save`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.tick`, `.applyConfigProperties`, `ZoomDimension`, `.clamp`, `LeawindThirdPersonImplMixin.java`, `.load`?**
