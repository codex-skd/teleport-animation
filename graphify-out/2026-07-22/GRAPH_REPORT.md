...
## Corpus Check
- 85 files · ~95,505 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 970 nodes · 2104 edges · 79 communities (69 shown, 10 thin omitted)
...
Cohesion: 0.11
Nodes (20): ComputeCameraAngles, Invoker, CameraAccessor, Mixin, Vec3, CallbackInfo, Inject, Mixin (+12 more)
...
Cohesion: 0.07
Nodes (4): LocalPlayer, BodyCameraHeights, Minecraft, Vec3
...
Cohesion: 0.06
Nodes (32): 0.0.0-beta.10 (2026-07-13), 0.0.0-beta.11 (2026-07-14), 0.0.0-beta.12 (2026-07-14), 0.0.0-beta.13 (2026-07-14), 0.0.0-beta.14 (2026-07-14), 0.0.0-beta.15 (2026-07-16), 0.0.0-beta.16 (2026-07-19), 0.0.0-beta.17 (2026-07-19) (+24 more)
...
### Community 53 - ".tick"
Cohesion: 0.12
Nodes (8): AbstractTickableSoundInstance, BobbyCompat, DistantHorizonsCompat, FadingTravelSound, Camera, Level, Logger, ResourceKey
...
Cohesion: 0.27
Nodes (8): Method, BlockPos, Entity, ItemStack, Level, ResourceKey, ServerPlayer, WaystonesWarpPlateHandler
...
### Community 75 - "CameraMixin.java"
Cohesion: 0.48
Nodes (5): CameraMixin, CallbackInfo, CameraRenderState, Inject, Mixin

## Knowledge Gaps
- **114 isolated node(s):** `OVERWORLD`, `NETHER`, `END`, `0.0.0-beta.28 (2026-07-22)`, `0.0.0-beta.27 (2026-07-22)` (+109 more)
...
- **Why does `TeleportTransitionController` connect `.getTravelEndTick` to `Minecraft`, `.shouldPreferVoxyOnlyTerrain`, `.isRunning`, `TeleportTransitionController.java`, `.handleWarpPlateTeleport`, `TeleportClient`, `LocalPlayer`, `LeawindThirdPersonImplMixin.java`, `.getCameraFrame`, `TeleportStepEffectRenderer`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.tick`, `.enterBodyFrame`, `ScreenEffectRendererMixin.java`?**
  _High betweenness centrality (0.305) - this node is a cross-community bridge._
- **Why does `TeleportConfig` connect `TeleportConfig` to `TeleportServer`, `TeleportClient`, `.getCameraFrame`, `.save`, `.getPullEndTick`, `KeyboardInputMixin.java`, `.applyConfigProperties`, `ZoomDimension`, `.clamp`, `LeawindThirdPersonImplMixin.java`, `ScreenEffectRendererMixin.java`, `.load`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `TeleportClient` connect `TeleportClient` to `StartServerTeleportPayload`, `.load`?**
