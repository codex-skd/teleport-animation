...
version = "0.0.0-beta.45"
release_type = "beta"
with open(f"docs/curseforge/versions/{version}.md", "r", encoding="utf-8") as f:
    changelog = f.read()
metadata = {
...
req = urllib.request.Request(
    "https://minecraft.curseforge.com/api/projects/1608291/upload-file",
    data=body,
    headers={
